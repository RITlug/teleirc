const IrcActionHandler = require('./Irchandlers/ActionHandler');
const IrcErrorHandler = require('./Irchandlers/ErrorHandler');
const IrcJoinHandler = require('./IrcHandlers/JoinHandler');
const IrcKickHandler = require('./Irchandlers/KickHandler');
const IrcMessageHandler = require('./IrcHandlers/MessageHandler');
const IrcPartHandler = require('./IrcHandlers/PartHandler');

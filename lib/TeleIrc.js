...
class TeleIrc {
  ...
  initStage5_initTelegramMessageSending() {
    ...
    this.tgEventListener = new TgEventListener(this.config.tg.chatId);
    ...
    this.tgbot.on('edited_message', teleirc.tgEventListener.ParseMessage.bind(teleirc.tgEventListener));

...
class TeleIrcErrorCodes {
    constructor() {
        // Let 0XXX Be "Developer" error codes - error codes
        // that are generated when developers do something
        // wrong (e.g. pass in undefined or null to a param).

        // Let 1XXX be irc configuration errors.

        this.MissingIrcConfig = 1000;
